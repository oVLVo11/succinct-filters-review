...
- 最终处理：A、C 的文本核查已由 Day 5/6 整合吸收；边界下标作为 Q1 限制进入正文，不再等待额外审阅文件。
...
| 式 (3)(4)(5) | Q1 | **已由 A 展开并合入定稿** | 见 `probability-and-space-proof.md` §3 与整合稿 §9.3；小组不再新增签字文件 |
...
完整审阅：`discussions/review-day3-C.md`、`discussions/review-day4-C.md`。以上意见已经成员 C 审核，成员回应和最终处理已在 Day 5/6 回填；Q1/Q3 按限制项保留，不再等待新增审阅文件。
...
| 历史问题 | 当前状态 | 证据 |
|---|---|---|
| A 概率/空间/下界列待补 | **已修订** | `probability-and-space-proof.md`、A 章、整合稿 §5/§9 |
| C 文献矩阵和相关研究待补 | **已修订** | `section-C-related-work-and-evaluation.md`、`citation-audit.md` |
| B 当前写入层就绪与小规模边界 | **已修订** | B 章 §3–§4、`review-day4-C.md` 回填表 |
| 式 (3)–(5) 并合 | **已修订** | A 概率笔记 §3、整合稿 §9.3 |
| PSW 完整下界骨架 | **已修订** | `lower-bound-notes.md` §14、A 章 §6 |
| 阶段下标、字面 10、位级峰值 | **最终公开 Q1/Q3** | `issue-stage-index.md`、`issue-constant-10.md`、整合稿附录 A |
| Day 7 口头交流与签字文件 | **按小组最终决议不再形成文件** | `meeting-day6.md` 最终决议；未写成已发生活动 |
