...
| Almeida et al., *Scalable Bloom Filters* (2007) | scalable Bloom filter | [1] | §1、§1.2、References | 不预知最终元素数的工程扩容对照 | 仅看摘要 | 组件数、查询时间、空间和 FPR 分配 | https://doi.org/10.1016/j.ipl.2006.10.007 |
| Guo et al., *Theory and Network Applications of Dynamic Bloom Filters* (2006) | dynamic Bloom filter | [16] | §1、References | 多组件动态增长与网络应用 | 仅看摘要 | 是否删除、阈值依赖、最坏查询数 | https://doi.org/10.1109/INFOCOM.2006.325 |
...
| Bender et al., *Don't Thrash: How to Cache Your Hash on Flash* (2012) | quotient filter | 未引用 | 无 | 原文未讨论的工程对照：删除、resize、局部性 | 仅看摘要 | resize 是否重读 key、容量/负载保证 | https://doi.org/10.14778/2350229.2350275 |
| Fan et al., *Cuckoo Filter: Practically Better Than Bloom* (2014) | cuckoo filter | 未引用 | 无 | 原文未讨论的 fingerprint 工程对照 | 仅看摘要/首页 | 插入失败、resize 与最坏保证 | https://doi.org/10.1145/2674005.2674994 |
